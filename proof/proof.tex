...
$\startsyntax
  ...
  &           & \proj{ps}{l} & = & \text{multiset}\{\process{c}{l'}\in ps~|~l'\sqsubseteq l\}  \\
  &           & \proj{\sigma}{l} & = & \lambda k. \proj{\sigma(k)}{l}  \\
  &           & \proj{e}{l} & = &
    \begin{cases}
      e  & \exists c,l'.~e=\evstart{\process{c}{l'}}\text{ and }l'\sqsubseteq l  \\
...
$\startrules
  ...
  \tsteprule{p-write}
        ...
        {\epsilon}
        {(\sigma,\process{c}{l})}
        {(\upd{\sigma}{k}{\s{write}(\sigma(k),v,l)},\{\process{c'}{l}\})}
  \tsteprule{p-fork}
        {\s{run}(c) = \opfork{c_1}{c_2}}
        {\epsilon}
        {(\sigma,\process{c}{l})}
        {(\sigma,\{\process{c_1}{l},\process{c_2}{l}\})}
...
$\startrules
  ...
  \ssteprule{s-skip}
        ...
        {(\sigma,ps)}
  \ssteprule{s-step}
        {\tstep{e}{(\sigma,\process{c}{l})}{(\sigma',ps')}}
        {e}
        {(\sigma,ps\uplus\{\process{c}{l}\})}
        {(\sigma',ps\uplus ps')}
\finishrules$
\\
