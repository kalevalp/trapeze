...
%\TODO{Does NSU preserve termination sensitivity?
%I thought it would leak half a bit by continuing execution in some
%cases while raising an error in other cases. --Tommy}
%NSU reduces faceting (which can be seen as a
